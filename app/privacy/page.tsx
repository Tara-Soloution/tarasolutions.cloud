...
const privacyFeatures = [
    {
        ...
        description: "We collect only the information necessary to provide and improve our services",
        icon: FileCheck,
        color: "text-blue-500",
                    ...
                    <div className="space-y-32">
                        ...
                        <section className="container">
                            <div className="text-center mb-16">
                                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">Our Privacy Commitments</h2>
                                <p className="text-lg text-muted-foreground">Built with security and transparency in mind</p>
                            </div>
                        ...
                        <section className="container">
                            <div className="max-w-4xl mx-auto space-y-12">
                                <div className="text-center mb-16">
                                    <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">Detailed Privacy Information</h2>
                                    <p className="text-lg text-muted-foreground">Understanding our data practices</p>
                                </div>
                        ...
                        <section className="container">
                            <div className="rounded-3xl border bg-card/50 backdrop-blur-sm p-12 text-center">
                                <div className="max-w-2xl mx-auto">
                                    ...
                                    <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">Questions About Our Privacy Policy?</h2>
