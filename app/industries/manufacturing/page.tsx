...
const features = [
  {
    ...
    description:
      "Advanced scheduling and resource optimization for efficient manufacturing processes",
    icon: Settings,
  ...
  },
  {
    ...
    description:
      "Comprehensive quality management and inspection tools for consistent output",
    icon: Target,
  ...
  },
  {
    ...
    description:
      "Real-time tracking and optimization of raw materials and finished goods",
    icon: Package,
    color: "text-blue-500",
  ...
  },
  {
    ...
    description:
      "Streamlined logistics and supplier management for cost-effective operations",
    icon: LineChart,
...
const benefits = [
  {
    ...
    description:
      "Optimized processes that reduce waste and increase productivity",
    icon: Brain,
  },
  {
    title: "Quality Assurance",
    description:
      "Built-in quality control measures for consistent product standards",
    icon: Shield,
  },
  {
          ...
          <div className="space-y-32">
              ...
              <div className="relative pt-32 pb-20 sm:pt-40 sm:pb-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                  ...
                  <p className="max-w-2xl mx-auto text-lg sm:text-xl text-muted-foreground mb-10">
                    ...
                    technology solutions designed to enhance efficiency,
            ...
            <section className="container mx-auto px-4">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground">
                  Comprehensive tools and platforms for modern manufacturing
                </p>
              </div>
            ...
            <section className="container mx-auto px-4">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground">
                  Experience the benefits of modern manufacturing technology
                </p>
              </div>
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                {benefits.map((benefit) => (
                  <div
                    key={benefit.title}
                    className="group relative overflow-hidden rounded-2xl border bg-card p-6 transition-all hover:shadow-lg hover:shadow-orange-500/20"
                  >
                    <div className="mb-4">
