...
const features = [
  {
    ...
    description:
      "Secure and efficient banking solutions for modern financial institutions",
    icon: CreditCard,
  ...
  },
  {
    ...
    description:
      "Comprehensive insurance processing and policy management systems",
    icon: Shield,
    color: "text-blue-500",
          ...
          <div className="space-y-32">
              ...
              <div className="relative pt-32 pb-20 sm:pt-40 sm:pb-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                  ...
                  <p className="max-w-2xl mx-auto text-lg sm:text-xl text-muted-foreground mb-10">
                    Transform your financial operations with cutting-edge
                    technology solutions designed to enhance security,
            ...
            <section className="container mx-auto px-4">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground">
                  Comprehensive tools and platforms for modern financial
                  services
                </p>
              </div>
            ...
            <section className="container mx-auto px-4">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground">
                  Experience the benefits of modern financial technology
                </p>
              </div>
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                {benefits.map((benefit) => (
                  <div
                    key={benefit.title}
                    className="group relative overflow-hidden rounded-2xl border bg-card p-6 transition-all hover:shadow-lg hover:shadow-yellow-500/20"
                  >
                    <div className="mb-4">
