            ...
            <div className="relative z-10">
                ...
                <section className="container py-24">
                    <div className="rounded-lg border bg-card p-8 text-center md:p-12">
                        <h2 className="text-3xl font-bold tracking-tight">Ready to Transform Your Educational Institution?</h2>
                        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                            Let's discuss how our education solutions can help you provide better learning experiences and improve student outcomes.
                        </p>
