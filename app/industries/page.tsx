...
const industries = [
  {
    title: "Healthcare",
    description:
      "Revolutionizing healthcare delivery with cutting-edge software solutions for hospitals, clinics, and healthcare providers.",
    icon: Hospital,
    color: "text-blue-500",
...
const benefits = [
  {
    ...
    description:
      "Deep understanding of your sector's unique challenges and requirements",
    icon: Sparkles,
  },
  {
            ...
            <section className="container  mx-auto px-4">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground">
                  Experience the difference of industry-focused expertise
                </p>
              </div>
            ...
            <section className="container  mx-auto px-4">
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                {industries.map((industry) => (
                  ...
                  >
                    <div
                      className={`mb-6 inline-flex rounded-xl p-4 ${industry.bgColor}`}
                    >
