...
import { ArrowRight, Building2, BarChart, FileText, Users, Shield, Brain, Clock, Target, LineChart } from "lucide-react"
...
const features = [
    {
        title: "ERP Systems",
        description: "Comprehensive enterprise resource planning solutions for business operations",
        icon: BarChart,
    ...
    },
    {
        ...
        description: "Streamlined business processes with intelligent automation tools",
        icon: Target,
    ...
    },
    {
        ...
        description: "Secure and efficient document handling and collaboration systems",
        icon: FileText,
                    ...
                    <div className="space-y-32">
                        ...
                        <div className="relative pt-32 pb-20 sm:pt-40 sm:pb-24">
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                                ...
                                <p className="max-w-2xl mx-auto text-lg sm:text-xl text-muted-foreground mb-10">
                                    Transform your enterprise with cutting-edge technology solutions designed to enhance efficiency, security, and business growth.
                                </p>
                                <Link href="/contact">
                        ...
                        <section className="container">
                            <div className="text-center mb-16">
                                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">Our Enterprise Solutions</h2>
                                <p className="text-lg text-muted-foreground">Comprehensive tools and platforms for modern enterprises</p>
                            </div>
                        ...
                        <section className="container">
                            <div className="text-center mb-16">
                                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">Why Choose Our Enterprise Solutions?</h2>
                                <p className="text-lg text-muted-foreground">Experience the benefits of modern enterprise technology</p>
                            </div>
                            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                                {benefits.map((benefit) => (
                                    <div key={benefit.title} className="group relative overflow-hidden rounded-2xl border bg-card p-6 transition-all hover:shadow-lg hover:shadow-indigo-500/20">
                                        <div className="mb-4">
                        ...
                        <section className="container">
                            <div className="rounded-3xl border bg-card/50 backdrop-blur-sm p-12">
                                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                                    ...
                                    <div className="text-center">
                                        <div className="text-4xl font-bold text-indigo-500 mb-2">20%</div>
                                    ...
                                    <div className="text-center">
                                        <div className="text-4xl font-bold text-indigo-500 mb-2">12/7</div>
