                    ...
                    <div className="space-y-32">
                        ...
                        <section className="container">
                            <div className="text-center mb-16">
                                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">Types of Cookies We Use</h2>
                                <p className="text-lg text-muted-foreground">Understanding our cookie categories</p>
                            </div>
                        ...
                        <section className="container">
                            <div className="max-w-4xl mx-auto space-y-12">
                                <div className="text-center mb-16">
                                    <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">Cookie Information</h2>
                                    <p className="text-lg text-muted-foreground">Detailed information about our cookie practices</p>
                                </div>
                                ...
                                <div className="grid gap-8 md:grid-cols-2">
                                    ...
                                    <div className="group relative overflow-hidden rounded-2xl border bg-card p-8 transition-all hover:shadow-lg hover:shadow-primary/20">
                                        <h3 className="text-2xl font-semibold mb-4">How to Control Cookies</h3>
                                        <p className="text-muted-foreground">
                                    ...
                                    <div className="group relative overflow-hidden rounded-2xl border bg-card p-8 transition-all hover:shadow-lg hover:shadow-primary/20">
                                        <h3 className="text-2xl font-semibold mb-4">Third-Party Cookies</h3>
                        ...
                        <section className="container">
                            <div className="rounded-3xl border bg-card/50 backdrop-blur-sm p-12 text-center">
                                <div className="max-w-2xl mx-auto">
                                    ...
                                    <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">Questions About Our Cookie Policy?</h2>
