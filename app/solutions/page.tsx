...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive enterprise solutions for modern businesses. From AI-optimized infrastructure to scalable cloud management, we provide cutting-edge technology solutions to drive your business forward.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Comprehensive enterprise solutions for modern businesses. From AI-optimized infrastructure to scalable cloud management.",
    images: [
      {
...
const benefits = [
  {
    ...
    description:
      "Stay ahead with the latest tech stack and innovative solutions",
    icon: Sparkles,
  },
  {
            ...
            <section className="container mx-auto px-4 py-16">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground">
                  Experience the power of modern technology solutions
                </p>
              </div>
            ...
            <section className="container mx-auto px-4 py-16">
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                {solutions.map((solution) => (
                  ...
                  >
                    <div
                      className={`mb-6 inline-flex rounded-xl p-4 ${solution.bgColor}`}
                    >
