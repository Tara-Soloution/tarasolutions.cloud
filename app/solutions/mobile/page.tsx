...
const process = [
    ...
    },
    {
        ...
        description: "We create beautiful mobile-first designs and interactive prototypes.",
        icon: Palette
    },
    {
        step: "03",
        title: "Development",
        description: "We build your mobile application using the latest technologies.",
        icon: Code
    },
    {
        step: "04",
        title: "Testing & Launch",
        description: "We thoroughly test and deploy your application to app stores.",
        icon: Zap
    }
]
                ...
                <div className="container mx-auto px-4 pt-24 pb-20">
                    ...
                    <div className="space-y-16">
                        ...
                        <section id="services" className="container space-y-12 py-16 md:py-24">
                            <div className="mx-auto max-w-[58rem] text-center">
                                <h2 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-3xl font-bold tracking-tight text-transparent sm:text-3xl md:text-5xl">Our Mobile Services</h2>
                                <p className="mt-4 text-muted-foreground/80 sm:text-lg">
                        ...
                        <section className="container space-y-12 py-16 md:py-24">
                            <div className="mx-auto max-w-[58rem] text-center">
                                ...
                                <p className="mt-4 text-muted-foreground/80 sm:text-lg">
                                    We use the latest technologies to build powerful mobile applications
                                </p>
                            </div>
                        ...
                        <section className="container space-y-16 py-24 md:py-32">
                            <div className="mx-auto max-w-[58rem] text-center">
                                <h2 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-3xl font-bold tracking-tight text-transparent sm:text-3xl md:text-5xl">Why Choose Our Mobile Solutions?</h2>
                                <p className="mt-4 text-muted-foreground/80 sm:text-lg">
                            ...
                            <div className="grid gap-8 md:grid-cols-2">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-xl font-bold tracking-tight text-transparent">Native Experience</h3>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-xl font-bold tracking-tight text-transparent">Cross-Platform</h3>
                                            <p className="text-muted-foreground/80">
                                                Efficient development for both iOS and Android platforms.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4">
