...
const process = [
    ...
    },
    {
        ...
        description: "We design a scalable and secure cloud architecture for your needs.",
        icon: Network
    },
    {
        step: "03",
        title: "Implementation",
        description: "We implement the cloud infrastructure and migrate your applications.",
        icon: Workflow
    },
    {
        step: "04",
        title: "Optimization",
        description: "We optimize performance and costs for your cloud environment.",
        icon: LineChart
    }
]
                    ...
                    <div className="space-y-16">
                        ...
                        <section className="container space-y-12 py-16 md:py-24">
                            <div className="mx-auto max-w-[58rem] text-center">
                                <h2 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-3xl font-bold tracking-tight text-transparent sm:text-3xl md:text-5xl">Our Cloud Journey</h2>
                        ...
                        <section id="services" className="container space-y-12 py-16 md:py-24">
                            <div className="mx-auto max-w-[58rem] text-center">
                                <h2 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-3xl font-bold tracking-tight text-transparent sm:text-3xl md:text-5xl">Our Cloud Services</h2>
                                <p className="mt-4 text-muted-foreground/80 sm:text-lg">
                        ...
                        <section className="container space-y-16 py-24 md:py-32">
                            <div className="mx-auto max-w-[58rem] text-center">
                                <h2 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-3xl font-bold tracking-tight text-transparent sm:text-3xl md:text-5xl">Why Choose Our Cloud Solutions?</h2>
                                <p className="mt-4 text-muted-foreground/80 sm:text-lg">
                            ...
                            <div className="grid gap-8 md:grid-cols-2">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-xl font-bold tracking-tight text-transparent">Scalability</h3>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-xl font-bold tracking-tight text-transparent">Security</h3>
                                            <p className="text-muted-foreground/80">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-xl font-bold tracking-tight text-transparent">Cost Optimization</h3>
                                            <p className="text-muted-foreground/80">
