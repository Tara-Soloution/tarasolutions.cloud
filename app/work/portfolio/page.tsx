...
export const metadata: Metadata = {
  ...
  description:
    "Explore our portfolio of successful projects and solutions. See how we've helped businesses transform their digital presence.",
};
    ...
    projects: [
      {
        title: "Ahsen Elite",
        description:
          "A modern e-commerce platform for luxury products with advanced features and seamless user experience.",
      ...
      },
      {
        ...
        description:
          "A comprehensive management system for business operations and analytics.",
    ...
    projects: [
      {
        ...
        description:
          "A secure and user-friendly mobile banking application for a leading financial institution.",
    ...
    projects: [
      {
        title: "Cloud Station",
        description:
          "A comprehensive cloud management platform for enterprise infrastructure and services.",
            ...
            <div className="container mx-auto px-4 py-16 relative pt-32 pb-20 sm:pt-40 sm:pb-24">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p className="max-w-2xl mx-auto text-lg sm:text-xl text-muted-foreground mb-10">
                  Explore our diverse collection of projects, from web
            ...
            <section className="container mx-auto px-4 py-16">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground">
                  Our tech stack for building robust solutions
                </p>
              </div>
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                {technologies.map((tech) => (
                  <div
                    key={tech.title}
                    className="group relative overflow-hidden rounded-2xl border bg-card/50 backdrop-blur-sm p-6 transition-all duration-300 hover:shadow-[0_0_30px_rgba(var(--primary),0.15)] hover:border-primary/20 hover:bg-card"
                  >
                    ...
                    <div className="relative">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {tech.items.map((item) => (
                          <span
                            key={item}
                            className="rounded-full bg-accent/50 px-3 py-1 text-sm transition-colors duration-300 group-hover:bg-accent/70"
                          >
                            {item}
                          </span>
                        ))}
            ...
            {portfolioCategories.map((category) => (
              <section key={category.title} className="container">
                <div className="flex items-center gap-4 mb-8">
                  <div
                    className={`rounded-xl p-3 ${category.bgColor} transition-transform duration-300 hover:scale-110`}
                  >
                          ...
                          <div className="w-full">
                            ...
                            <div className="flex flex-wrap gap-1.5 mb-4">
                              {project.tags.map((tag) => (
                                <span
                                  key={tag}
                                  className="rounded-full bg-white/10 backdrop-blur-sm px-2.5 py-0.5 text-xs text-white"
                                >
                                  {tag}
                                </span>
                              ))}
