...
const workExperience = [
  {
    ...
    description:
      "As the founding CEO of Tara Solutions, I lead the company in developing cutting-edge solutions and driving business growth. My focus is on strategic planning, team leadership, and ensuring the company's vision aligns with market needs.",
    technologies: [
  ...
  },
  {
    ...
    description:
      "Leading the development of Laravel and Filament packages for Ramaki's Large Enterprise Ecommerce platform, implementing comprehensive management systems for tenants, sellers, products, warehouses, and inventory.",
    technologies: [
      "Laravel",
      "Filament",
      "Livewire",
  ...
  },
  {
    ...
    description:
      "Led the development of comprehensive ERP systems, implemented CI/CD pipelines, and managed team collaboration for efficient project delivery.",
  ...
  },
  {
    ...
    description:
      "Designed and implemented database solutions for various enterprise applications including ecommerce, payroll management, and task management systems.",
    technologies: [
      "Database Design",
      "System Architecture",
  ...
  },
  {
    ...
    description:
      "Developed web applications and taught programming languages while mentoring aspiring developers.",
...
const projects = [
  {
    ...
    description:
      "Enterprise-scale ecommerce platform with multi-tenancy support, multi-language capabilities, and comprehensive management systems for products, warehouses, and inventory.",
    technologies: [
      "Laravel",
      "Filament",
      "Livewire",
  ...
  },
  {
    title: "DAWEO MIS",
    description:
      "Management Information System for Danner Afghanistan for Women Empowerment Organization, supporting operations across multiple provinces with comprehensive management features.",
    technologies: ["React.js", "Laravel", "Chakra UI", "Tailwind CSS"],
  },
  {
    title: "Shahre-Kodak ERP",
    description:
      "Complete enterprise resource planning system for a chain store, including HR, stock, product, sales, and store management modules.",
...
const awards = [
  {
    ...
    year: "2024, 2023",
    description:
      "Promoter of Religious and Cultural Understanding, Fosterer of Interfaith dialogue",
  },
  {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="max-w-2xl mx-auto text-lg sm:text-xl text-muted-foreground mb-8">
                  ...
                  architecture and business strategy, driving innovation and
                  growth at Tara Solutions.
                </p>
                <div className="flex space-x-4 mb-8">
                  <Button variant="ghost" size="icon" asChild>
                    <a
                      href="https://www.linkedin.com/in/rustam-ali-hussaini"
                      target="_blank"
                  ...
                  <Button variant="ghost" size="icon" asChild>
                    <a
                      href="https://github.com/RustamAliHussaini"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <Button variant="ghost" size="icon" asChild>
                    <a
                      href="https://twitter.com/rustamhussaini"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
