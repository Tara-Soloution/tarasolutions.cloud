...
import { Server, Shield, Zap, Clock, Database, Cpu, HardDrive, ShieldCheck,  Check } from "lucide-react"

import CTASection from '@/components/cta-section'

export const metadata: Metadata = {
    title: "Premium Web Hosting Services | Fast, Secure & Reliable",
    description: "Get lightning-fast, secure, and reliable web hosting with AI-powered tools. Choose from our Stellar, Stellar Plus, and Stellar Business plans. 99.9% uptime guarantee, free SSL, and 24/7 support.",
    keywords: "web hosting, website hosting, cloud hosting, shared hosting, SSL hosting, fast hosting, secure hosting, reliable hosting, AI hosting, website builder",
    openGraph: {
        title: "Premium Web Hosting Services | Fast, Secure & Reliable",
        description: "Get lightning-fast, secure, and reliable web hosting with AI-powered tools. Choose from our Stellar, Stellar Plus, and Stellar Business plans.",
        type: "website",
...
const hostingPlans = [
    {
        ...
        popular: false,
        renewalInfo: "Renews at €5.99/month"
    },
    {
        title: "Stellar Plus",
        ...
        popular: true,
        renewalInfo: "Renews at €7.99/month"
    },
    {
        ...
        popular: false,
        renewalInfo: "Renews at €10.99/month"
    }
]
...
export default function HostingPage() {
    const jsonLd = {
        ...
        "description": "Get lightning-fast, secure, and reliable web hosting with AI-powered tools",
        "offers": {
            "@type": "AggregateOffer",
                        ...
                        <div className="container mx-auto px-4 py-16 relative pt-32 pb-20 sm:pt-40 sm:pb-24">
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                                ...
                                <p className="max-w-2xl mx-auto text-lg sm:text-xl text-muted-foreground mb-10">
                                    Fast, secure, and reliable web hosting with AI-powered tools and unmetered resources.
                                </p>
                            ...
                            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 items-start">
                                {hostingPlans.map((plan) => (
                                    ...
                                    >
                                        ...
                                        <div className={`p-8 ${plan.popular ? 'pt-8 bg-gradient-to-b from-primary/[0.03] to-transparent' : ''}`}>
                                            <div className={`${plan.popular ? 'pt-4' : ''}`}>
                                                <h3 className={`text-2xl font-semibold mb-3 ${plan.popular ? 'text-primary' : ''}`}>{plan.title}</h3>
                                                ...
                                                <div className="mb-6">
                                                    ...
                                                    <div className="text-sm text-muted-foreground mt-2">{plan.renewalInfo}</div>
                                                </div>
                                                ...
                                                <ul className="space-y-4">
                                                    {plan.features.map((feature) => (
                                                        <li key={feature} className="flex items-center gap-3">
                                                            <div className={`rounded-full p-1 ${plan.popular ? 'bg-primary/20' : 'bg-primary/10'}`}>
                                                                <Check className={`h-4 w-4 ${plan.popular ? 'text-primary' : 'text-primary/80'}`} />
                                                            </div>
