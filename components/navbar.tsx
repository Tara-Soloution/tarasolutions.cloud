      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            ...
            <span className="text-xl font-semibold bg-gradient-to-r from-primary to-green-500 bg-clip-text text-transparent">
              Tara Solutions
            </span>
          </Link>
                ...
                <div className="p-4">
                  ...
                  <div className="space-y-1">
                    <Link
                      ...
                      className="flex items-center space-x-3 px-4 py-3 rounded-lg text-sm text-muted-foreground hover:bg-primary/5 hover:text-primary transition-colors"
                    >
